...
def content(root):
        ...
        Frameelectronic = LabelFrame(root,text="Cooking Essentials", bd=12,relief=RIDGE,padx=20,bg="powder blue",font=("times new roman",12,"bold"))
        Frameelectronic.place(x=20,y=200,width=240,height=240)

        buttonviewdetail = Button(root, text="View Details", padx=2, pady=2,bd=10,fg="white",bg="purple",font=("times new roman",12,"bold"),command=lambda :viewdetails("cooking"))
        buttonviewdetail.place(x=75, y=250)
        buttonadd = Button(root, text="QR Code", padx=2, pady=2,bd=10,fg="white",bg="purple",font=("times new roman",12,"bold"),command=lambda :qr("cooking"))
        ...
        #===================================== clothing =========================================
        Frameclothing = LabelFrame(root, text="Food & Beverages", bd=12, relief=RIDGE, padx=20, bg="powder blue",
        ...
        Framegrocery = LabelFrame(root, text="Household Supplies", bd=12, relief=RIDGE, padx=20, bg="powder blue",
                                  font=("times new roman", 12, "bold"))
