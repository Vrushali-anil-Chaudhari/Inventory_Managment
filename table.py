...
def viewdetail(root,name):
    ...
    b2=Button(root,text='Delete',command=delete,fg="white", borderwidth=3, relief="solid",bg="purple",font=("times new roman",12,"bold")).place(x=194,y=50)
    L2=Label(root,text="  Enter id number  ",fg="white", borderwidth=3, relief="solid",bg="purple",font=("times new roman",12,"bold")).place(x=100,y=15)
    global e1
    e1 = Entry(root)
    e1.place(x=250,y=20)
    tabular(root,name)
