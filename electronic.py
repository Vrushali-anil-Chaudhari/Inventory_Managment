...
def content(root):
        ...
        lbltitle=Label(root,text="Electronic",bg="powder blue",fg="black",bd=20,relief=RIDGE,font=("times new roman",50,"bold"),padx=2,pady=6)
        lbltitle.pack(side=TOP,fill=X)

        #===============================mobile=================================

        Frameelectronic = LabelFrame(root,text="Mobile", bd=12,relief=RIDGE,padx=20,bg="powder blue",font=("times new roman",12,"bold"))
        Frameelectronic.place(x=20,y=200,width=240,height=240)

        buttonviewdetail = Button(root, text="View Details", padx=2, pady=2,bd=10,fg="white",bg="purple",font=("times new roman",12,"bold"),command=lambda :viewdetails("mobile"))
        buttonviewdetail.place(x=75, y=250)
        buttonadd = Button(root, text="QR Code", padx=2, pady=2,bd=10,fg="white",bg="purple",font=("times new roman",12,"bold"),command=lambda :qr("mobile"))
...
#===================================== clothing =========================================
        Frameclothing = LabelFrame(root, text="Laptop", bd=12, relief=RIDGE, padx=20, bg="powder blue",
        ...
        Framegrocery = LabelFrame(root, text="Washing Machine", bd=12, relief=RIDGE, padx=20, bg="powder blue",
                                   font=("times new roman", 12, "bold"))
