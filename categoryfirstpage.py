...
def mainscreen(root):
    ...
    lbltitle=Label(root,text="Inventory management system",bg="powder blue",fg="black",bd=20,relief=RIDGE,font=("times new roman",50,"bold"),padx=2,pady=6)
    lbltitle.pack(side=TOP,fill=X)

    buttonviewdetail = Button(root, text="Electronic", padx=50, pady=50, bd=10, fg="white", bg="purple",
                          font=("times new roman", 20, "bold"),command=electronics)
    buttonviewdetail.place(x=40, y=280)
#=====================================================
    buttonviewdetail = Button(root, text=" Clothing ", padx=50, pady=50, bd=10, fg="white", bg="purple",
                          font=("times new roman", 20, "bold"),command=clothings)
    buttonviewdetail.place(x=370, y=280)
#================================================================
    buttonviewdetail = Button(root, text="  Grocery ", padx=50, pady=50, bd=10, fg="white", bg="purple",
                          font=("times new roman", 20, "bold"),command=groceries)
#=====================================================================================================
    buttonviewdetail.place(x=700, y=280)
    buttonviewdetail = Button(root, text="  sports  ", padx=50, pady=50, bd=10, fg="white", bg="purple",
